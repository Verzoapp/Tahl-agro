...
const LeftSideBar = () => {
  ...
  const navigation = [
    ...
    {
      name: "Crop Profiles",
      href: "/dashboard/crop-profile",
      current: pathname === "/dashboard/crop-profile",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
    ...
    {
      name: "Farmer Input",
      href: "/dashboard/farm-inputs",
      current: pathname === "/dashboard/farm-inputs",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
    ...
    },
    {
      ...
      current: pathname === "/dashboard/farm-activities",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
    ...
    },
    {
      ...
      href: "/dashboard/geo-area",
      current: pathname === "/dashboard/geo-area",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
    ...
    },
    {
      ...
      current: pathname === "/dashboard/equipments",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
  ...
  return (
    <>
      ...
      <div className="hidden lg:fixed xl:fixed xl:inset-y-0 xl:z-10 xl:flex lg:inset-y-0 lg:z-10 lg:flex lg:w-[250px] lg:flex-col">
        {/* Sidebar component, swap this element with another sidebar if you like */}
        <div className="flex grow flex-col gap-y-9 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
          <div className="flex h-8 mt-[10px] shrink-0 items-center">
            <Logo />
          </div>
          <nav className="flex flex-1 flex-col">
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
