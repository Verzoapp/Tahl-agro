...
interface DeleteLandGroupModalProps {
  ...
  setOpenDeleteLandGroupModal: React.Dispatch<React.SetStateAction<boolean>>;
  landGroupId: string
}
...
const DeleteLandGroupModal = ({
  openDeleteLandGroupModal,
  setOpenDeleteLandGroupModal,
  landGroupId
}: DeleteLandGroupModalProps): JSX.Element => {
  ...
  const onSubmitHandler = async (form: FormData) => {
    try {
      ...
      setOpenDeleteLandGroupModal(false)
  ...
  return (
    <Transition.Root show={openDeleteLandGroupModal} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={setOpenDeleteLandGroupModal}>
        <Transition.Child
          as={Fragment}
...
export default DeleteLandGroupModal;
